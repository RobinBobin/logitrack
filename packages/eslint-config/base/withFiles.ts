...
const config: ConfigObject = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-invalid-void-type': ['error', ts.noInvalidVoidType],
    ...
    '@typescript-eslint/no-use-before-define': ['error', ts.noUseBeforeDefine],
...
type TFiles = Exclude<ConfigObject['files'], undefined>

export type TFilesR = ReadonlyDeep<TFiles>

export const withFiles = (files: TFilesR): ConfigObject => ({
  ...config,
